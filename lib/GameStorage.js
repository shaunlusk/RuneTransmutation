...
RuneTx.GameStorage = {
  ...
  updateSelectedLevel : function(value) {
    this.storage.put(RuneTx.StorageKey.SELECTED_LEVEL, value);
  },
  ...
  updateCurrentRune : function(rune) {
    this.storage.putObject(RuneTx.StorageKey.CURRENT_RUNE, rune);
  },
  ...
  getSelectedLevel : function() {
    var level = this.storage.get(RuneTx.StorageKey.SELECTED_LEVEL);
  ...
  getCurrentRune : function() {
    var rune = this.storage.getObject(RuneTx.StorageKey.CURRENT_RUNE);
    return rune ? new RuneTx.RuneTile(rune._rune, rune._color) : null;
  },
  ...
  _dumpSaveData:function() {
      ...
      console.log("Level Jump Selected Level:", this.getSelectedLevel());
  }
};
