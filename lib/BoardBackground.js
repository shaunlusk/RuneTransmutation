...
RuneTx.BoardBackground = function(screenContext, parentLayer, props) {
  ...
  this._boardOffsetX = props.boardOffsetX ? Math.floor(props.boardOffsetX / (C64Style.CELLWIDTH * screenContext.getScaleX())) : 0;
  this._boardOffsetY = props.boardOffsetY ? Math.floor(props.boardOffsetY / (C64Style.CELLHEIGHT * screenContext.getScaleY())) : 0;
