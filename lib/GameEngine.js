...
RuneTx.GameEngine = function(props) {
  ...
  this._generateWildRunePct = props.generateWildRunePct || 0.03;
  this._generateRuneDestroyer = props.generateRuneDestroyer || 0.03;
  ...
  this._newGameButtonOffsetY = props.newGameButtonOffsetY || 28 * C64Style.CELLHEIGHT;
  this._cellWidth = 16;
  this._cellHeight = 16;
...
RuneTx.GameEngine.prototype._drawRuneBox = function() {
  this._backgroundLayer.drawBorder(0, 0, 3, 3, C64Style.Color.WHITE);
};

RuneTx.GameEngine.prototype._drawColorDepthGuide = function() {
  var width = 2 + 4 * (this._currentLevelDefinition.boardColors.length - 1);
...
RuneTx.GameEngine.prototype.generateRune = function() {
  ...
  if (pct < this._generateWildRunePct) {
    this._currentRune = new RuneTx.RuneTile(this._currentLevelDefinition.startingRune, C64Style.Color.WHITE);
  } else {
    pct = Math.random();
...
RuneTx.GameEngine.prototype.handleMouseClick = function(event) {
  ...
  if (this._betweenLevels || this._runeIsMoving) return;
