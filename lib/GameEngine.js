...
RuneTx.GameEngine.prototype.jumpToLevel = function(level) {
  this._level = level - 1;
  this._nextLevel();
};
...
RuneTx.GameEngine.prototype._removeNonBoardElements = function() {
...
RuneTx.GameEngine.prototype.generateRune = function() {
  var pct = Math.random();
  if (pct < this._generateWildRunePct + (this._level / 1500)) {
    this._currentRune = this._wildRuneTile;
  } else {
    pct = Math.random();
    if (pct < this._generateRuneDestroyer + (this._level / 1500)) {
