...
RuneTx.GameEngine = function(props) {
  ...
  this.on(RuneTx.EventType.PLACE_RUNE, this._setGameStateDirty.bind(this));
  ...
  this.on(RuneTx.EventType.UPDATE_LEVEL, this._setGameStateDirty.bind(this));
...
RuneTx.GameEngine.prototype.clearBoardLayers = function() {
  ...
  RuneTx.removeAllElementsFromGfxLayer(this._foregroundLayer);
...
RuneTx.GameEngine.prototype._setGameStateDirty = function() {
  console.log("game dirty");
  this._gameStateDirty = true;
};
